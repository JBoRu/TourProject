...
class Sentiment_trainer:
    ...
    def iteration(self, epoch, data_loader, train=True, df_name="df_log.pickle"):
        ...
        for i, data in data_iter:
            ...
            # 计算auc
            auc = metrics.recall_score(y_true=all_labels,
                                                     y_pred=all_predictions, average='micro')
...
if __name__ == '__main__':
    def init_trainer(dynamic_lr, batch_size=3):
        trainer = Sentiment_trainer(max_seq_len=500,
